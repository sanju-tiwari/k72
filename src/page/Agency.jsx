...
function Agency() {
  ...
  const imageCount = [
    {title:"Conseillere" , name:"Sophie auger" , img:"/image/CAMILLE_480X640_2-480x640.jpg"},
    {title:"Directeur conseil" , name:"carl godbout" , img:"/image/Carl_480x640-480x640.jpg"},
    {title:"Conceptrice redaction" , name:"camille birere" , img:"/image/ChantalG_480x640-480x640.jpg"},
    {title:"Conseillere" , name:"claire robert" , img:"/image/HugoJoseph_480x640-480x640.jpg"},
    {title:"Conseiller Principal" , name:" Arnaud doyon " , img:"/image/joel_480X640_3-480x640.jpg"},
    {title:"VPP at directeur general" , name:" Pierre-lau paiement" , img:"/image/Lawrence_480x640-480x640.jpg"},
    {title:"Directrice artistique" , name:" melanie laviolette " , img:"/image/MAXIME_480X640_2-480x640.jpg"},
    {title:"Directrice conseil" , name:"michele riendeau" , img:"/image/MEGGIE_480X640_2-480x640.jpg" },
    {title:" Stratege" , name:"beatrice roussin" , img:"/image/MEL_480X640-480x640.jpg"},
    {title:"Conseillere" , name:" lou gravel-jean " , img:"/image/SophieA_480x640-480x640.jpg"},
    {title:" Planificatrice strategique principal " , name:"olivier roeyaerts" ,img:"/image/Michele_480X640-480x640.jpg"},
    {title:"Coordonatrice" , name:"lawrence meunier" , img:"/image/MyleneS_480x640-480x640.jpg"},
    {title:"Directrice consell" , name:" isabelle beauchemin " , img:"/image/Olivier_480x640-480x640.jpg"},
    {title:"Directeur artistique" , name:" hugo joseph " , img:"/image/SophieA_480x640-480x640.jpg"},
  ]
useGSAP(() => {
    ...
    <div ref={scrollRef} className="overflow-x-hidden bg-color-white  ">
      ...
      <div className="section-2 h-[40rem] xl:h-auto w-screen   ">
        <div className=' flex flex-row items-start mt-15 md:mt-25 xl:mt-15  md:w-3/5 font-[font2] text-xl justify-around  gap-10 ' >
            <div>
               <h1 className="font-[font2] font-bold " >
                Expertise
               </h1>
            </div>
  ...
  <p className="max-w-sm">
    <span className="font-semibold text-black">Our projects_</span> are born in humility, nurtured by curiosity, and sustained by creativity in all its forms.
  </p>
  <p className="max-w-sm">
    <span className="font-semibold text-black">Our creation_</span> thrives in an environment where talent is encouraged to shine—where you feel free to become the best version of yourself.
  </p>
  <p className="max-w-sm">
    <span className="font-semibold text-black">Our culture_</span> is rooted in openness. Together, our crew shapes an agency we are truly proud of.
  </p>
</div>
      ...
      <div className=" section-3  w-screen  mt-50 overflow-hidden  " >
              <div ref={scrollRef2} className=" first h-full w-full flex relative items-center justify-center  " >    
                   <div className="  h-full w-[35rem] rounded-4xl  " >
                          <img className="  z-[10] h-full relative w-full object-cover rounded-4xl " src="/image/Olivier_480x640-480x640.jpg " alt="" />
        ...
        <div className="flex whitespace-nowrap  justify-between  font-[font2] alex-glow items-center ">
          <h1 className="uppercase text-4xl md:text-[15rem]  font-bold mr-[10rem] ">Alex</h1>
          <h1 className="uppercase text-4xl md:text-[15rem]  font-bold">Alex</h1>
      ...
      <div className="alex-container z-20 absolute bottom-5  left-0 w-full overflow-hidden text-[#D3FD50]  ">
        <div className="flex whitespace-nowrap  justify-between  font-[font2] alex-glow2 items-center ">
          <h1 className="uppercase text-4xl md:text-[10rem]  font-bold mr-[10rem] ">SAUVAGEAU <span className=" ml-2 text-2xl text-white " >Directeur artistique</span> </h1>
        </div>
        </div>

                   </div>
                </div>    
                   <div ref={scrollRef3} className=" second h-full w-full flex relative items-center justify-center z-60 " >    
                   <div className=" z-40 h-full w-[35rem] rounded-4xl  " >
                          <img className=" z-[10] h-full w-full relative object-cover rounded-4xl " src="/image/MyleneS_480x640-480x640.jpg" alt="" /> 
      <div className="alex-container z-0   absolute top-5  left-0 w-full overflow-hidden text-[#D3FD50]  ">
        <div className="flex whitespace-nowrap  justify-between  font-[font2] alex-glow items-center ">
          <h1 className="uppercase text-4xl md:text-[10rem] font-bold mr-[10rem] ">MICHÈLE</h1>
          <h1 className="uppercase text-4xl md:text-[10rem]  font-bold">MICHÈLE</h1>
           
        </div>
      </div>
      <div className="alex-container z-20 absolute bottom-5  left-0 w-full overflow-hidden text-[#D3FD50]  ">
        <div className="flex whitespace-nowrap  justify-between  font-[font2] alex-glow2 items-center ">
          <h1 className="uppercase text-4xl md:text-[10rem]  font-bold mr-[10rem] ">RIENDEAU
 <span className=" ml-2 text-2xl text-white " >Directrice de la stratégie</span> </h1>
        </div>
        </div>       
  ...
  >
    <div className="relative w-full h-full rounded-2xl overflow-hidden">
      ...
      >
        <h2 className="font-[font2] text-sm md:text-xl ml-5 ">{items.title}</h2>
        <h1 className="font-[font2] uppercase text-sm md:text-2xl mr-5 ">{items.name}</h1>
      </div>
    ...
    >
      <img className=" h-full w-full object-cover rounded-2xl " src={items.img} alt="" />
    </div>
