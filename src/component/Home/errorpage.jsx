...
export default function Modern404Page() {
      ...
      <div className="relative z-10 text-center max-w-4xl mx-auto px-6">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-8">
          <button
            ...
            className="group relative px-8 py-4 bg-gradient-to-r from-purple-600 to-blue-600 text-white font-semibold rounded-xl overflow-hidden transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-purple-500/25"
          >
          ...
          <button
            ...
            className="group px-8 z-99 py-4 border-2 border-slate-600 text-slate-300 font-semibold rounded-xl transition-all duration-300 hover:border-purple-400 hover:text-white hover:bg-purple-400/10"
          >
